...
$scope.submit = function(){
 ...
 send["You level of knowledge at the start of the course:"]=document.getElementById("3_1").value;
 send["You level of knowledge at the end of the course:"]=document.getElementById("3_2").value;
